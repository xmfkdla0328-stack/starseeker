  ...
  return (
    <div className="h-full relative flex flex-col items-center justify-center p-6 animate-fade-in">
      ...
      <div onClick={cycleMainChar} className="relative z-10 cursor-pointer group mt-10">
         ...
         {/* 캐릭터 원형 컨테이너 */}
         <div className={`w-64 h-64 md:w-80 md:h-80 rounded-full border-4 ${ELEMENTS[mainChar.element].border} ${ELEMENTS[mainChar.element].bg} flex items-center justify-center shadow-[0_0_30px_rgba(0,0,0,0.2)] transition-transform duration-500 group-hover:scale-105 relative overflow-hidden backdrop-blur-sm`}>
