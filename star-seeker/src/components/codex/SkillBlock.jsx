 ...
 */
export const SkillBlock = ({ type, name, desc, colorClass, level = 1, cooldown }) => (
  <div className="bg-slate-900/50 p-3 rounded-lg border border-white/5 flex gap-3 items-center">
    ...
    <div className="flex-1">
      <div className={`text-sm font-bold flex items-center gap-2 flex-wrap ${colorClass.split(' ')[0].replace('border-','text-')}`}>
        {name}
